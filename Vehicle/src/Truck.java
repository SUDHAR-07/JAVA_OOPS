...
public class Truck extends Vehicle{
    ...
    public Truck(String vehicle_name, int speed, String motor_Description, int max_power, int no_of_seats, int no_of_doors, String color, int production_year, ArrayList<String> accessories, ArrayList<String> extras, boolean hasTrailer) {
